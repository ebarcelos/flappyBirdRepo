...
public class ObstacleFactory {
    ...
    public static GameObject getNewObstacle() {
...
//        ObstacleType obstacleType = ObstacleType.values()[random];
    ...
    private static GameObject singleTopObstacle() {
        return new SingleTopObstacle(500, 200, ObstacleType.SATA_PLANE);
    }

    private static GameObject singleBottomObstacle() {
    ...
    private static GameObject doubleObstacle() {
